...
if($datos!=null ){
   $message='<table><td>'.CHtml::image(Yii::app()->baseUrl . '/images/offer_image/'.$datos[0]->imagen, 'Cuba',array('class'=>'img-circle','style'=>'width:50px;')).'</td><td><p style="padding-left:7px">'.$datos[0]->message.'</p></td></table>';
//echo '<pre>';
