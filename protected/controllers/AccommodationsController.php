...
class AccommodationsController extends Controller
{
	 ...
	 */
	public $layout='//layouts/accommodations';
	...
	{
		$model=new Accommodations('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Accommodations']))
			$model->attributes=$_GET['Accommodations'];
	...
	{
		$model=Accommodations::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Accommodations $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='accommodations-form')
		{
